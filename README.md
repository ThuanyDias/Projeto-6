...
Mapear dados e aplicar alterações

Filtrar produtos com base em critérios específicos
...
Métodos funcionais do JavaScript
...
Aplicado para transformar os dados, como por exemplo modificar valores ou aplicar regras específicas.

🔹 filter()

Usado para exibir apenas produtos que atendem a determinada condição (ex: categoria específica).
